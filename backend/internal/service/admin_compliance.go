...
const (
	...
	AdminComplianceDocumentURLZH  = "https://github.com/YLeon2007/sub2api/blob/v0.1.176-ru.1/docs/legal/admin-compliance.zh.md"
	AdminComplianceDocumentURLEN  = "https://github.com/YLeon2007/sub2api/blob/v0.1.176-ru.1/docs/legal/admin-compliance.en.md"
	AdminComplianceDocumentURLRU  = "https://github.com/YLeon2007/sub2api/blob/v0.1.176-ru.1/docs/legal/admin-compliance.ru.md"
	...
	AdminComplianceAckPhraseRU    = "Я прочитал, понял и принимаю обязательство по соблюдению требований при развёртывании и эксплуатации Sub2API"
