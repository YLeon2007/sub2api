...
describe("admin SettingsView payment visible method controls", () => {
  ...
  it("links Russian payment guidance to immutable fork documentation", async () => {
    ...
    expect(paymentLinks).toHaveLength(2);
    expect(paymentLinks[0]?.attributes("href")).toBe(
      "https://github.com/YLeon2007/sub2api/blob/v0.2.1-ru.1/docs/PAYMENT_RU.md",
    );
    expect(paymentLinks[1]?.attributes("href")).toBe(
      "https://github.com/YLeon2007/sub2api/blob/v0.2.1-ru.1/docs/PAYMENT_RU.md#поддерживаемые-провайдеры",
    );
  });
