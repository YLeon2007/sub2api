...
const paymentGuideHref = computed(() => {
  ...
  if (isRuLocale.value) {
    return "https://github.com/YLeon2007/sub2api/blob/v0.2.7-ru.3/docs/PAYMENT_RU.md";
  }
...
const paymentMethodsHref = computed(() => {
  ...
  if (isRuLocale.value) {
    return "https://github.com/YLeon2007/sub2api/blob/v0.2.7-ru.3/docs/PAYMENT_RU.md#поддерживаемые-провайдеры";
  }
