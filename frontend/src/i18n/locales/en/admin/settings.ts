export default {
    settings: {
      ...
      gatewayForwarding: {
        ...
        grokCrossClientMapHint: 'Enabled by default. Disable it to prevent GPT, Codex, o-series, and Claude model IDs from being routed to the default Grok text model above.',
