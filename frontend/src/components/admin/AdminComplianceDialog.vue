...
const documentUrl = computed(() => {
  const locale = getLocale()
  if (locale === 'zh') {
    return complianceStore.status?.document_url_zh || 'https://github.com/YLeon2007/sub2api/blob/v0.1.180-ru.1/docs/legal/admin-compliance.zh.md'
  }
  if (locale === 'ru') {
    return complianceStore.status?.document_url_ru || 'https://github.com/YLeon2007/sub2api/blob/v0.1.180-ru.1/docs/legal/admin-compliance.ru.md'
  }
  return complianceStore.status?.document_url_en || 'https://github.com/YLeon2007/sub2api/blob/v0.1.180-ru.1/docs/legal/admin-compliance.en.md'
})
