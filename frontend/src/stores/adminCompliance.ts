...
export const useAdminComplianceStore = defineStore('adminCompliance', () => {
  ...
  function requireAcknowledgement(partialStatus?: Partial<AdminComplianceStatus>): void {
    status.value = {
      ...
      document_url_zh: partialStatus?.document_url_zh || status.value?.document_url_zh || 'https://github.com/YLeon2007/sub2api/blob/v0.1.180-ru.1/docs/legal/admin-compliance.zh.md',
      document_url_en: partialStatus?.document_url_en || status.value?.document_url_en || 'https://github.com/YLeon2007/sub2api/blob/v0.1.180-ru.1/docs/legal/admin-compliance.en.md',
      document_url_ru: partialStatus?.document_url_ru || status.value?.document_url_ru || 'https://github.com/YLeon2007/sub2api/blob/v0.1.180-ru.1/docs/legal/admin-compliance.ru.md',
