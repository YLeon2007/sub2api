...
The Russian Admin Compliance translation was adapted from source commit
...
The source repository and this fork are distributed under the GNU Lesser
General Public License v3.0. See [`LICENSE`](../LICENSE) for the full license
text.
