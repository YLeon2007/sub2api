...
- Этот документ: `https://github.com/YLeon2007/sub2api/blob/v0.1.180-ru.1/docs/ADMIN_PAYMENT_INTEGRATION_API_RU.md`
- Китайская/английская версия: `https://github.com/YLeon2007/sub2api/blob/v0.1.180-ru.1/docs/ADMIN_PAYMENT_INTEGRATION_API.md`
