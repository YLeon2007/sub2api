...
- Этот документ: `https://github.com/YLeon2007/sub2api/blob/v0.2.7-ru.3/docs/ADMIN_PAYMENT_INTEGRATION_API_RU.md`
- Китайская/английская версия: `https://github.com/YLeon2007/sub2api/blob/v0.2.7-ru.3/docs/ADMIN_PAYMENT_INTEGRATION_API.md`
