...
- 当前文档：`https://github.com/YLeon2007/sub2api/blob/v0.2.2-ru.1/docs/ADMIN_PAYMENT_INTEGRATION_API.md`
- 俄语文档：`https://github.com/YLeon2007/sub2api/blob/v0.2.2-ru.1/docs/ADMIN_PAYMENT_INTEGRATION_API_RU.md`
...
- This document: `https://github.com/YLeon2007/sub2api/blob/v0.2.2-ru.1/docs/ADMIN_PAYMENT_INTEGRATION_API.md`
- Russian: `https://github.com/YLeon2007/sub2api/blob/v0.2.2-ru.1/docs/ADMIN_PAYMENT_INTEGRATION_API_RU.md`
