...
```dotenv
APPLE_CONTAINER_SUB2API_IMAGE=ghcr.io/yleon2007/sub2api:0.2.5-ru.1
...
SUB2API_IMAGE=ghcr.io/yleon2007/sub2api:0.2.5-ru.1 # Должен совпадать с APPLE_CONTAINER_SUB2API_IMAGE в .env.
