...
```dotenv
APPLE_CONTAINER_SUB2API_IMAGE=ghcr.io/yleon2007/sub2api:0.1.171-ru.1
...
SUB2API_IMAGE=ghcr.io/yleon2007/sub2api:0.1.171-ru.1 # Match APPLE_CONTAINER_SUB2API_IMAGE in .env.
