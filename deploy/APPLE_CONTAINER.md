...
```dotenv
APPLE_CONTAINER_SUB2API_IMAGE=ghcr.io/yleon2007/sub2api:0.2.1-ru.2
...
SUB2API_IMAGE=ghcr.io/yleon2007/sub2api:0.2.1-ru.2 # Match APPLE_CONTAINER_SUB2API_IMAGE in .env.
