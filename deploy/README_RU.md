...
Fork defaults используют immutable image `ghcr.io/yleon2007/sub2api:0.2.7-ru.2`. Новые releases требуют явной смены tag; не переводите production на чужой mutable `latest`.
