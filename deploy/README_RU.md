...
Fork defaults используют immutable image `ghcr.io/yleon2007/sub2api:0.2.3-ru.1`. Новые releases требуют явной смены tag; не переводите production на чужой mutable `latest`.
